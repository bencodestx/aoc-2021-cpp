...
TEST(Day2, Part1) {
  ...
  EXPECT_EQ(150, aoc2021::day2::part1(in));
}
...
// is 0, your depth does not change. down 5 adds 5 to your aim, resulting in a
// value of 5. forward 8 adds 8 to your horizontal position, a total of 13.
// Because your aim is 5, your depth increases by 8*5=40. up 3 decreases your
// aim by 3, resulting in a value of 2. down 8 adds 8 to your aim, resulting in
// a value of 10. forward 2 adds 2 to your horizontal position, a total of 15.
...
TEST(Day2, Part2) {
  ...
  EXPECT_EQ(900, aoc2021::day2::part2(in));
}
